...
class Oversee::Components::Field::Set < Oversee::Components::Field
  def view_template
  ...
  def value_state
    render Oversee::Components::Field::Display.new(resource:, key:, value:, datatype:, **@options)
  ...
  def input_state
    render Oversee::Components::Field::Form.new(resource: @resource, datatype:, key:, value:)
  end
